...
<br>
		...
		<a href="viewtable.php?table=all_sfdc&action=duplicates&comparisonfield=Email" class="btn btn-default <?php if($totalSFDC == 0){ echo 'hidden'; } ?> " title="VIEW DUPLICATES"><i class="fa fa-copy"></i></a>
		...
		<div class="panel panel-default">
  			...
  			<div class="panel-body">
    			<ol>
					...
					<li>Upload SFDC</li>
					<li>Run country extract list from Eloqua (Segment: <a href="https://secure.p01.eloqua.com/Main.aspx#segments&id=3578" target="_blank"> ANZ AU All Contacts</a> or <a href="https://secure.p01.eloqua.com/Main.aspx#segments&id=2089" target="_blank">NZ Contacts</a>) <strong>CONTACT VIEW</strong> <span style="text-decoration: line-through;">(may need to customise to add subscriptions?)</span></li>
					<li>Open ELQ report. Insert new column A with the heading: id </li>
					<li>Upload Eloqua List</li>
					<br>
					<li>Export then delete duplicates from SFDC</li>
					<li>Export then delete duplicates from custom list</li>
					<li>Compare Custom, SFDC and ELQ to remove invalid contacts
						<ul>
							<li>In Custom but not in SDFC</li>
							<li>Mail Flag in SFDC M,N, or missing</li>
							<li>Email Permission in ELQ = False</li>
							<li style="text-decoration: line-through;">ELQ Subscriptions</li>
						</ul>
					</li>
					<li>Validate email addresses in Custom.  <span style="text-decoration: line-through">Repair, then</span> export & delete fails</li>
					<li style="text-decoration: line-through;">Repaired emails in ELQ and SFDC?</li>
					<li style="text-decoration: line-through;">Compare Custom & SFDC & Eloqua where not in Eloqua, export and upload to eloqua through New Contacts program</li>
					<li>MORE TO COME....</li>
    			</ol>
  			</div>
		</div>
