...
<div id="main-header">
    <div class="navbar">
        <div class="navbar-inner">
            <div class="container">
                <hgroup>
                    <div id="brand-logo">
                        <a class="thermo-fisher-scientifc logo" href="http://www.thermofisher.co.nz<?php
    if(isset($_GET['conference'])){
        $ac = $conn->query("SELECT * FROM conferences WHERE id='" . $_GET['conference'] . "'");
        $conn->error;
        $rowAc = $ac->fetch_assoc();
 ...
 "><img src="http://img.en25.com/Web/ThermoFisherScientificLPG/{7813dd0d-526a-4027-a251-86d246df0c97}_thermo-fisher-logo-retina.png" width="160" height="39"/> </a>
                        ...
                        <div class="brand">NZIFST 2016</div>
                    </div>
                </hgroup>
               ...
               <div class="nav-collapse navbar-responsive-collapse collapse">
                    <ul class="nav">
                        <li><a href="http://info.thermofisher.co.nz/LP=4011">Home</a></li>
                        <li><a href="http://info.thermofisher.co.nz/LP=4013">Products</a></li>
                        <li><a href="http://info.thermofisher.co.nz/LP=4012">Contact</a></li>
                    </ul>
                </div>
            </div>
        </div>
