...
<a href="l2page_i.php" class="btn btn-primary btn-xs" style="width: 80px;">List</a>&nbsp;&nbsp;
<a href="l2page_au_v.php?id=<?php echo $_GET['id']; ?>" class="btn btn-primary btn-xs" style="width: 80px;">View Page</a>
<br>
<br>
